...
import {
  CheckSamePasswordAction,
  newPaswordCreationAction,
...
export default function NewPassword({route}) {
  ...
  const setNewpasswordFN = () => {
    ...
    var obj = {
      phone_number: cellno.replace('+63', ''),
      password: password,
    ...
    dispatch(
      CheckSamePasswordAction(samePassObj, data => {
        console.log(data);
