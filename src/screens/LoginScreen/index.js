...
const clientID =
  '274927645478-6jq3vb9mph0j7kud7knkq5sciir7uv4c.apps.googleusercontent.com';
...
export default function LoginScreen() {
  ...
  const {loading, loadingFacebook, loadingGoogle} = useSelector(
    ({authRed}) => authRed,
  );
  ...
  const socialLogin = (userData, source) => {
    var obj = {
      ...
      profile_image:
        source == 'google' ? userData.photo : userData.picture.data.url,
    };
    dispatch(
      SocialLogin(obj, (userId, userToken) => {
        getTokenAndSave(userId, userToken);
      }),
    );
  };
          ...
          <View style={styles.bottomTxt}>
            ...
            <TouchableOpacity
              ...
              <TextBold
                style={[
                  styles.loginInputHeading,
                  {textDecorationLine: 'underline', color: '#B52551'},
                ]}>
                {' '}
                {t('common.signup')}
              </TextBold>
